...
import App from './App';
import { Model, config_4x4, config_5x5} from './model/Model'
...
test("config 4x4 has red cell at row 3, column B", () => {expect(new Model(config_5x5).puzzle.cells[3][2].color).toBe("red")});
test("config 4x4 has blank cell at row 4, column C", () => {expect(new Model(config_5x5).puzzle.cells[4][3].color).toBe("white")});
test("config 4x4 has blank cell at row 2, column A", () => {expect(new Model(config_5x5).puzzle.cells[2][1].color).toBe("white")});
